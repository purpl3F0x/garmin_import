...
******************************************************************************/
typedef void
(*TTWATCH_RACE_ENUMERATOR)(TTWATCH_ACTIVITY activity, int index, const TTWATCH_RACE_FILE *file, void *data);

/******************************************************************************
* Callback function for ttwatch_enumerate_history_entries. 'index' is 0-based *
******************************************************************************/
typedef void
(*TTWATCH_HISTORY_ENUMERATOR)(TTWATCH_ACTIVITY activity, int index, const TTWATCH_HISTORY_ENTRY *entry, void *data);
