...
TTBIN_FILE *parse_ttbin_data(const uint8_t *data, uint32_t size) {
  ...
  for (p.data = data; p.data < end; p.data += length) {
    ...
    switch (p.record->tag) {
      case TAG_SUMMARY:file->activity = p.record->summary.activity;
        ...
        break;
      case TAG_STATUS:record = append_record(file, p.record->tag, length);
      ...
      case TAG_GPS:
        ...
        break;
      case TAG_HEART_RATE:record = append_record(file, p.record->tag, length);
        ...
        break;
      case TAG_LAP:record = append_record(file, p.record->tag, length);
        ...
        break;
      case TAG_CYCLING_CADENCE:record = append_record(file, p.record->tag, length);
        ...
        break;
      case TAG_TREADMILL:record = append_record(file, p.record->tag, length);
        ...
        break;
      case TAG_SWIM:record = append_record(file, p.record->tag, length);
        ...
        break;
      case TAG_RACE_SETUP:record = append_record(file, p.record->tag, length);
      ...
      case TAG_RACE_RESULT:
        ...
        break;
      case TAG_TRAINING_SETUP:record = append_record(file, p.record->tag, length);
        ...
        break;
      case TAG_GOAL_PROGRESS:record = append_record(file, p.record->tag, length);
        ...
        break;
      case TAG_INTERVAL_SETUP:record = append_record(file, p.record->tag, length);
        ...
        break;
      case TAG_INTERVAL_START:record = append_record(file, p.record->tag, length);
        record->interval_start.type = p.record->interval_start.type;
        append_array(&file->interval_start_records, record);
        break;
      case TAG_INTERVAL_FINISH:record = append_record(file, p.record->tag, length);
        ...
        break;
      case TAG_ALTITUDE_UPDATE:record = append_record(file, p.record->tag, length);
        ...
        break;
      case TAG_POOL_SIZE:record = append_record(file, p.record->tag, length);
        record->pool_size.pool_size = p.record->pool_size.pool_size;
        file->pool_size = record;
        break;
      case TAG_WHEEL_SIZE:record = append_record(file, p.record->tag, length);
        record->wheel_size.wheel_size = p.record->wheel_size.wheel_size;
        file->wheel_size = record;
        break;
      case TAG_HEART_RATE_RECOVERY:record = append_record(file, p.record->tag, length);
        ...
        break;
      case TAG_GYM:record = append_record(file, p.record->tag, length);
        ...
        break;
      case TAG_FITNESS_POINT:record = append_record(file, p.record->tag, length);
...
void delete_record(TTBIN_FILE *ttbin, TTBIN_RECORD *record) {
  switch (record->tag) {
    case TAG_GPS: remove_array(&ttbin->gps_records, record);
      break;
    case TAG_LAP: remove_array(&ttbin->lap_records, record);
      break;
    case TAG_HEART_RATE: remove_array(&ttbin->heart_rate_records, record);
      break;
    case TAG_TREADMILL: remove_array(&ttbin->treadmill_records, record);
      break;
    case TAG_SWIM: remove_array(&ttbin->swim_records, record);
      break;
    case TAG_STATUS: remove_array(&ttbin->status_records, record);
      break;
    case TAG_GOAL_PROGRESS: remove_array(&ttbin->goal_progress_records, record);
      break;
    case TAG_INTERVAL_START: remove_array(&ttbin->interval_start_records, record);
      break;
    case TAG_INTERVAL_FINISH: remove_array(&ttbin->interval_finish_records, record);
      break;
    case TAG_ALTITUDE_UPDATE: remove_array(&ttbin->altitude_records, record);
      break;
    case TAG_GYM: remove_array(&ttbin->gym_records, record);
      break;
    case TAG_FITNESS_POINT: remove_array(&ttbin->fitness_point_records, record);
      break;
    case TAG_CYCLING_CADENCE: remove_array(&ttbin->cycling_cadence_records, record);
      break;
  }
...
const char *create_filename(TTBIN_FILE *ttbin, const char *ext) {
  ...
  switch (ttbin->activity) {
    case ACTIVITY_RUNNING: type = "Running";
      break;
    case ACTIVITY_CYCLING: type = "Cycling";
      break;
    case ACTIVITY_SWIMMING: type = "Pool_swim";
      break;
    case ACTIVITY_TREADMILL: type = "Treadmill";
      break;
    case ACTIVITY_FREESTYLE: type = "Freestyle";
      break;
    case ACTIVITY_GYM: type = "Gym";
      break;
    case ACTIVITY_INDOOR: type = "Indoor";
      break;
    case ACTIVITY_HIKING: type = "Hiking";
      break;
    case ACTIVITY_TRAILRUNNING: type = "Trailrunning";
      break;
    case ACTIVITY_SKIING: type = "Skiing";
      break;
    case ACTIVITY_SNOWBOARDING: type = "Snowboarding";
      break;
  }
...
static void update_summary_information(TTBIN_FILE *ttbin) {
  ...
  switch (ttbin->activity) {
    ...
    case ACTIVITY_SNOWBOARDING:i = ttbin->gps_records.count;
      while (i > 0) {
      ...
      break;
    case ACTIVITY_SWIMMING:record = ttbin->swim_records.records[ttbin->swim_records.count - 1];
      ...
      break;
    case ACTIVITY_TREADMILL:record = ttbin->treadmill_records.records[ttbin->treadmill_records.count - 1];
      ...
      break;
    case ACTIVITY_GYM:record = ttbin->gym_records.records[ttbin->gym_records.count - 1];
